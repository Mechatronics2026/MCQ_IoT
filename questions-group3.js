...
var quizData = [
    ...
    { 
        ...
        correctAnswer: "A",
        explanation_en: "The main purpose of WoT (Web of Things) is to improve the usability and interoperability in IoT systems.",
        explanation_ar: "الغرض الرئيسي من ويب الأشياء (WoT) هو تحسين قابلية الاستخدام والتشغيل البيني في أنظمة إنترنت الأشياء."
    },
    { 
    ...
    { 
        ...
        correctAnswer: "C",
        explanation_en: "MQTT is a lightweight protocol designed for constrained devices and low-bandwidth, high-latency networks.",
        explanation_ar: "MQTT هو بروتوكول خفيف الوزن مصمم للأجهزة المحدودة والشبكات ذات النطاق الترددي المنخفض والكُمون العالي."
    },
    { 
        ...
        correctAnswer: "C",
        explanation_en: "The main role of Big Data is to store data on a real-time basis. It uses multiple storage technologies to store the data.",
        explanation_ar: "الدور الرئيسي للبيانات الضخمة هو تخزين البيانات في الوقت الفعلي. يستخدم تقنيات تخزين متعددة لتخزين البيانات."
    },
    { 
    ...
    { 
        ...
        correctAnswer: "D",
        explanation_en: "MQTT stands for Message Queue Telemetry Transport, a lightweight messaging protocol for small sensors and mobile devices.",
        explanation_ar: "MQTT تعني نقل قياس عن بعد طابور الرسائل، وهو بروتوكول مراسلة خفيف الوزن لأجهزة الاستشعار الصغيرة والأجهزة المحمولة."
    },
    { 
        ...
        correctAnswer: "C",
        explanation_en: "The full form of ICT is Information and Communication Technology. ICT is a multidimensional term for the IT sector that refers to all communication technologies, including the Internet, wireless networks, cell phones, computers, and software.",
        explanation_ar: "النموذج الكامل لـ ICT هو تكنولوجيا المعلومات والاتصالات. ICT هو مصطلح متعدد الأبعاد لقطاع تكنولوجيا المعلومات الذي يشير إلى جميع تقنيات الاتصالات، بما في ذلك الإنترنت والشبكات اللاسلكية والهواتف الخلوية وأجهزة الكمبيوتر والبرمجيات."
    },
    { 
        ...
        correctAnswer: "B",
        explanation_en: "The frequency of this board is 400 MHz. The Galileo gen 2 board frequency gives the speed of operation of the board. Therefore, the speed increases as the frequency increases.",
        explanation_ar: "تردد هذه اللوحة هو 400 ميجا هرتز. يعطي تردد لوحة Galileo gen 2 سرعة تشغيل اللوحة. لذلك، تزداد السرعة مع زيادة التردد."
    },
    { 
    ...
    { 
        ...
        correctAnswer: "C",
        explanation_en: "The standard port number for secure MQTT is 8883, while regular MQTT uses port 1883.",
        explanation_ar: "رقم المنفذ القياسي لـ MQTT الآمن هو 8883، بينما يستخدم MQTT العادي المنفذ 1883."
    },
    { 
        ...
        correctAnswer: "C",
        explanation_en: "The transport layer focuses on end-to-end communication, and it gives reliability and congestion avoidance that packets will be delivered in the same way as the user sent the packet.",
        explanation_ar: "تركز طبقة النقل على الاتصال من طرف إلى طرف، وتعطي موثوقية وتجنب الازدحام بحيث يتم تسليم الحزم بنفس الطريقة التي أرسلها المستخدم."
    },
    { 
    ...
    { 
        ...
        correctAnswer: "A",
        explanation_en: "Fingerprint sensors typically use UART (Universal Asynchronous Receiver-Transmitter) interface for communication.",
        explanation_ar: "تستخدم أجهزة استشعار البصمة عادة واجهة UART (جهاز الإرسال والاستقبال غير المتزامن العالمي) للاتصال."
    },
    { 
        ...
        correctAnswer: "B",
        explanation_en: "The most commonly used protocol for USART in asynchronous mode is RS232C. This protocol describes the physical interface for relatively low-speed serial data-communication between devices and computers.",
        explanation_ar: "البروتوكول الأكثر استخدامًا لـ USART في الوضع غير المتزامن هو RS232C. يصف هذا البروتوكول الواجهة المادية لاتصال البيانات التسلسلية منخفضة السرعة نسبيًا بين الأجهزة وأجهزة الكمبيوتر."
    },
    { 
    ...
    { 
        ...
        correctAnswer: "B",
        explanation_en: "I2C is commonly known as the Two Wire Interface because it uses only two wires for communication: SDA (Serial Data) and SCL (Serial Clock).",
        explanation_ar: "يُعرف I2C commonly باسم واجهة السلكين لأنه يستخدم سلكين فقط للاتصال: SDA (البيانات التسلسلية) وSCL (الساعة التسلسلية)."
    },
    { 
    ...
    { 
        ...
        correctAnswer: "B",
        explanation_en: "SPI stands for Serial Peripheral Interface. The SPI protocol is commonly used to secure digital card applications and liquid crystal displays.",
        explanation_ar: "SPI تعني الواجهة الطرفية التسلسلية. يُستخدم بروتوكول SPI commonly لتأمين تطبيقات البطاقات الرقمية وشاشات الكريستال السائل."
    },
    { 
        ...
        correctAnswer: "A",
        explanation_en: "SPI protocol typically uses five logic signals: SCLK, MOSI, MISO, SS, and GND.",
        explanation_ar: "يستخدم بروتوكول SPI typically خمس إشارات منطقية: SCLK, MOSI, MISO, SS, و GND."
    },
    { 
    ...
    { 
        ...
        correctAnswer: "B",
        explanation_en: "The full form of HART is Highway Addressable Remote Transducer. It is a master and slave protocol in which a slave device only speaks when spoken by a master.",
        explanation_ar: "النموذج الكامل لـ HART هو المحول البعيد القابل للعنونة للطريق السريع. إنه بروتوكول رئيسي وتابع حيث يتحدث الجهاز التابع فقط عندما يتحدث إليه الرئيس."
    },
    { 
    ...
    { 
        ...
        explanation_ar: "يستخدم ZigBee Smart Energy typically طوبولوجيا النجمة حيث تتواصل الأجهزة من خلال منسق مركزي."
    },
    { 
        ...
        correctAnswer: "D",
        explanation_en: "Secure MQTT is a session layer protocol. It is an extended version of the MQTT protocol that uses encryption based on lightweight attribute-based encryption.",
        explanation_ar: "MQTT الآمن هو بروتوكول طبقة الجلسة. إنه نسخة موسعة من بروتوكول MQTT الذي يستخدم التشفير based on lightweight attribute-based encryption."
    },
    { 
        ...
        correctAnswer: "D",
        explanation_en: "A Queued SPI is a type of SPI controller that is used to send a data queue from the SPI bus.",
        explanation_ar: "SPI المُصفى هو نوع من وحدة تحكم SPI يُستخدم لإرسال قائمة انتظار بيانات من ناقل SPI."
    },
    { 
    ...
    { 
        ...
        correctAnswer: "A",
        explanation_en: "Z-Wave operates at 908.42 GHz frequency in North America for wireless communication.",
        explanation_ar: "يعمل زد-ويف بتردد 908.42 جيجا هرتز في أمريكا الشمالية للاتصال اللاسلكي."
    },
    { 
        ...
        correctAnswer: "D",
        explanation_en: "The tactile sensor is also called a touch sensor. It is an electronic sensor used for detecting physical touch. The size of this sensor is very small.",
        explanation_ar: "يُسمى مستشعر اللمس أيضًا مستشعر اللمس. إنه مستشعر إلكتروني يُستخدم للكشف عن اللمس المادي. حجم هذا المستشعر صغير جدًا."
    },
    { 
    ...
    { 
        ...
        correctAnswer: "B",
        explanation_en: "GSN (Global Sensor Networks) is primarily implemented using Java programming language for sensor data management and processing.",
        explanation_ar: "يتم تنفيذ GSN (شبكات الاستشعار العالمية) primarily using Java programming language for sensor data management and processing."
    },
    { 
        ...
        correctAnswer: "B",
        explanation_en: "Short-range wireless networks have a very short range. This type of network is used for applications running in the local environment. Examples of this network are Wi-Fi and Bluetooth.",
        explanation_ar: "الشبكات اللاسلكية قصيرة المدى لها مدى قصير جدًا. يُستخدم هذا النوع من الشبكات للتطبيقات التي تعمل في البيئة المحلية. أمثلة على هذه الشبكة هي الواي فاي والبلوتوث."
    }
